...
const Onboarding = () => {
  ...
  return (
    <MainContent
      style={{
        backgroundColor: currentStepData.fillColor,
        position: "relative",
      }}
    >
      ...
      <View style={styles.contentWrapper}>
        ...
        <View style={styles.content}>
          <View
            style={{
              ...styles.tagContainer,
              backgroundColor: currentStepData.tagFillColor,
            }}
          >
          ...
          >
            {currentStepData.text.split(" ").map((text) => {
              const isTextInHighlighted =
                currentStepData.textsToHighlight.includes(

...
type Props = ViewProps & { isPadded?: boolean, isSafeArea?: boolean, showTopNav?: boolean, showBackButton?: boolean, showTitle?: boolean, title?: string, onBackPress?: () => void, titleStyle?: object, children?: React.ReactNode, backBtnStyle?: object, backBtnIconColor?: string, backBtnIconSize?: number, style?: object };
const MainContent = (props: Props) => {
    const insets = useSafeAreaInsets().top;
    const { isPadded, showBackButton, showTitle, title, style, isSafeArea, showTopNav, children, titleStyle, backBtnStyle, onBackPress, backBtnIconColor, backBtnIconSize } = props;
